...
static_assert(
    mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>>::map_type,
...
static_assert(mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>>::map_type,
                                                   mpl::bind<quote<is_convertible>, decltype(std::make_tuple("", "")),
                                                             mpl::_1>>>::type>::type::value ==
                  element_type::regex_element,
              "");

static_assert(
    mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>>::map_type,
                                         mpl::bind<quote<is_convertible>, decltype(builder()), mpl::_1>>>::type>::type::
            value == element_type::document_element,
    "");

static_assert(
    mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>>::map_type,
                                         mpl::bind<quote<is_convertible>, decltype(std::make_tuple("", document())),
                                                   mpl::_1>>>::type>::type::value ==
...
static_assert(
    mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>, true>::map_type,
...
static_assert(mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>, true>::map_type,
                                                   mpl::bind<quote<is_constructible>, mpl::_1, const double>>>::type>::
                      type::value == element_type::double_element,
              "");
...
static_assert(mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>, true>::map_type,
                                                   mpl::bind<quote<is_constructible>, mpl::_1,
                                                             decltype(std::make_tuple("", ""))>>>::type>::type::value ==
                  element_type::regex_element,
              "");

static_assert(
    mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>, true>::map_type,
                                         mpl::bind<quote<is_constructible>, mpl::_1, decltype(builder())>>>::type>::
            type::value == element_type::document_element,
    "");

static_assert(
    mpl::first<mpl::deref<find_if_second<TypeMap<std::vector<char>, true>::map_type,
                                         mpl::bind<quote<is_constructible>, mpl::_1,
                                                   decltype(std::make_tuple("", document()))>>>::type>::type::value ==
        element_type::scoped_javascript_element,
    "");
