...
enum class element_type : uint8_t {
    ...
    string_element = 0x02,   //!< std::string or boost::string_ref (string_type)
    ...
    undefined_element __attribute__((deprecated)) = 0x06,//!< void \deprecated use null_element instead
    ...
    db_pointer_element __attribute__((deprecated)) = 0x0C, //!< std::tuple<string_type, std::array<char, 12>>
                                                           //!< \deprecated use a string_element + oid_element
    javascript_element = 0x0D, //!< string_type
    symbol_element __attribute__((deprecated)) = 0x0E, //!< string_type
