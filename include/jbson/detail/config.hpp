...
#define JBSON_PUSH_DISABLE_DEPRECATED_WARNING _Pragma("warning(push)") _Pragma("warning(disable:1786)")
#elif defined(BOOST_MSVC)
#define JBSON_PUSH_DISABLE_DEPRECATED_WARNING _Pragma("warning(push)") _Pragma("warning(disable:4996)")
#else
#define JBSON_PUSH_DISABLE_DEPRECATED_WARNING
#endif
#endif // DOXYGEN_SHOULD_SKIP_THIS
...
#if defined(BOOST_CLANG)
#define JBSON_PUSH_DISABLE_DOCUMENTATION_WARNING                                                                       \
    _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wdocumentation\"")
#else
#define JBSON_PUSH_DISABLE_DOCUMENTATION_WARNING
#endif
#endif // DOXYGEN_SHOULD_SKIP_THIS
