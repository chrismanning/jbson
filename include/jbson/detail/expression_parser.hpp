...
inline bool parse_path_expression(std::experimental::string_view& expr, ast::path_expression& ast);
inline bool parse_path_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_path_descent(std::experimental::string_view& expr, std::vector<ast::path_descend>& ast);
inline bool parse_path_descent(std::experimental::string_view& expr, ast::path_descend& ast);
inline bool parse_union(std::experimental::string_view& expr, ast::path_union& ast);
inline bool parse_eval_operand(std::experimental::string_view& expr, ast::child_operand& ast);
inline bool parse_wildcard(std::experimental::string_view& expr, ast::field_access& ast);
inline bool parse_wildcard(std::experimental::string_view& expr, ast::child_operand& ast);
inline bool parse_field(std::experimental::string_view& expr, ast::field_access& ast);
inline bool parse_field(std::experimental::string_view& expr, ast::child_operand& ast);
inline bool parse_slice(std::experimental::string_view& expr, ast::slice& ast);
inline bool parse_slice(std::experimental::string_view& expr, ast::child_operand& ast);
inline bool parse_eval_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_logical_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_logical_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_equality_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_equality_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_relational_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_relational_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_additive_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_additive_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_multiplicative_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_multiplicative_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_unary_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_unary_expression(std::experimental::string_view& expr, ast::unary& ast);
inline bool parse_primary_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_int(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_quoted_string(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_path(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_parens_expression(std::experimental::string_view& expr, ast::expression& ast);
inline bool parse_parens_expression(std::experimental::string_view& expr, ast::operand& ast);
inline bool parse_bool(std::experimental::string_view& expr, ast::operand& ast);
inline void skip_space(std::experimental::string_view& expr);
...
inline bool parse_field(std::experimental::string_view& expr, ast::field_access& ast) {
    skip_space(expr);
    auto loc_expr = expr;
    std::experimental::optional<char> quote;
    if(boost::algorithm::any_of_equal("\"'"_sv, loc_expr.front())) {
...
inline bool parse_logical_expression(std::experimental::string_view& expr, ast::expression& ast) {
    static const std::map<std::experimental::string_view, ast::optoken> logical_op{{"||", ast::optoken::op_or},
                                                                                   {"&&", ast::optoken::op_and}};
    skip_space(expr);
...
inline bool parse_equality_expression(std::experimental::string_view& expr, ast::expression& ast) {
    static const std::map<std::experimental::string_view, ast::optoken> equality_op{{"==", ast::optoken::equal},
...
inline bool parse_relational_expression(std::experimental::string_view& expr, ast::expression& ast) {
    static const std::map<std::experimental::string_view, ast::optoken> relational_op{
        {"<", ast::optoken::less},
        {">", ast::optoken::greater},
...
inline bool parse_primary_expression(std::experimental::string_view& expr, ast::operand& operand) {
    skip_space(expr);
    return !expr.empty() &&
...
inline bool parse_subpath(std::experimental::string_view& loc_expr, std::string& path) {
    skip_space(loc_expr);
    if(loc_expr.front() == '[')
        loc_expr.remove_prefix(1);
