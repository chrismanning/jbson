...
using ElementTypeMap = typename mpl::at<
    typename mpl::map<mpl::pair<element_type_c<element_type::double_element>, double>,
                      ...
                      mpl::pair<element_type_c<element_type::regex_element>, std::pair<std::string, std::string>>,
                      mpl::pair<element_type_c<element_type::db_pointer_element>, char>,
                      mpl::pair<element_type_c<element_type::javascript_element>, char>,
                      mpl::pair<element_type_c<element_type::symbol_element>, char>,
                      mpl::pair<element_type_c<element_type::scoped_javascript_element>, char>,
